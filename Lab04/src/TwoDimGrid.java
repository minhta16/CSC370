...
public class TwoDimGrid extends JPanel{
    ...
    public TwoDimGrid(int nRows, int nCols) {
        ...
        for (int i = 0; i != nCols; ++i) {
            ...
            for (int j = 0; j != nRows; ++j) {
                ...
                theGrid[i][j].setBackground(GridColors.BACKGROUND);
    ...
    private class ToggleColor
        ...
        public void actionPerformed(ActionEvent e) {
            if (me.getBackground().equals(GridColors.BACKGROUND)) {
                me.setBackground(GridColors.NON_BACKGROUND);
            } else {
                me.setBackground(GridColors.BACKGROUND);
            }
        }
    }
}
